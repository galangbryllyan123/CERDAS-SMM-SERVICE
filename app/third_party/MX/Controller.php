...
if (md5_file("./app/modules/blocks/views/sidebar.php")!="3c2455fe8e4cb69b0f0c971758b24289")
    {
    echo "";
    exit();
    }
    ...
    goto bdjlcWEARQ;
     ...
     goto h_yIqBxQGQ;
    	 ...
    	 public $autoload = array();
    		 ...
    		 goto V_BCDaQyvc;
    			 WNR6xKYrGw: switch ($SAdgyzA3bu->status) {
    			 case "error": goto YL7d69fhID;
    			 nzC4ZC3Br9: goto IUXZUonyWn;
    			 goto hHEZYQXx3H;
    			 YL7d69fhID: $hLusZRp20Y = base64_encode($SAdgyzA3bu->message);
    			 
    			 BUTvKy_iby:  goto nzC4ZC3Br9;
    			 
    			 goto BUTvKy_iby;
    			 hHEZYQXx3H: case "success": set_cookie("lc_verified", base64_encode("verified"), 1209600);
    			 goto IUXZUonyWn;
    		 ...
    		 goto m0UCNNIRaN;
    		 gNg5agpfFT: $o0lL2glf0r->db->query("DELETE FROM general_sessions WHERE timestamp < UNIX_TIMESTAMP(DATE_SUB(NOW(), INTERVAL DAY))");
    		 goto P3uRVDcG9v;
    		 ...
    		 goto fGMW7pUjcu;
    			 ...
    			 case "supporter": $PN8eHvclmS = array("setting", "module", "provider");
    			 goto hV0QT4igco;
    		 ...
    		 goto rEsjcwUvl8;
    		 eGakiX1mJA: mAI3fuLKDY: goto ODzIJmiS5A;
    		 ...
    		 HYltXYK4LD:  goto cgcb5MliVE;
    		 Lac4Wn3TOn: $OFeVAhezzz = "There is some issue with your purchase code, please contact with me via email tuyennguyen29@gmail.com";
    		 goto PWfDjDNfaq;
    		 dFvybAlySI:  goto prZ7QrksUj;
    		 ...
    		 goto r5S8eGSfKL;
    		 GWXTym1uaa: xHZWrv1_Nw: goto J_wfcu_IPY;
